 ...
 <meta charset="utf-8">
  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="{{url('/')}}">Soeurs Karra</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Magasin</a>
              <div class="dropdown-menu" aria-labelledby="dropdown04">
              	<a class="dropdown-item" href="{{url('/magasin_jus')}}">Gamme jus </a>
              	<a class="dropdown-item" href="{{url('/magasin_café')}}">Gamme café et thé</a>
                <a class="dropdown-item" href="{{url('/magasin_salé')}}">Gamme salé</a>
                <a class="dropdown-item" href="{{url('/panier')}}">Panier</a>
